...
use App\Http\Controllers\Backend\NewsTickerDetailsController;
use App\Http\Controllers\Backend\VendorCommissionController;
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // News Ticker All Route
    Route::controller(NewsTickerController::class)->group(function () {
        Route::get('/all/newsTicker', 'AllNewsTicker')->name('all.newsTicker');
        Route::get('/add/newsTicker', 'AddNewsTicker')->name('add.newsTicker');
        Route::post('/store/newsTicker', 'StoreNewsTicker')->name('store.newsTicker');
        Route::get('/edit/newsTicker/{id}', 'EditNewsTicker')->name('edit.newsTicker');
        Route::post('/update/newsTicker', 'UpdateNewsTicker')->name('update.newsTicker');
        Route::get('/delete/newsTicker/{id}', 'DeleteNewsTicker')->name('delete.newsTicker');
    });

    // News Ticker Details All Route
    Route::controller(NewsTickerDetailsController::class)->group(function () {
        Route::get('/all/newsTickerDetails', 'AllNewsTickerDetails')->name('all.newsTickerDetails');
        Route::get('/add/newsTickerDetails', 'AddNewsTickerDetails')->name('add.newsTickerDetails');
        Route::post('/store/newsTickerDetails', 'StoreNewsTickerDetails')->name('store.newsTickerDetails');
        Route::get('/edit/newsTickerDetails/{id}', 'EditNewsTickerDetails')->name('edit.newsTickerDetails');
        Route::post('/update/newsTickerDetails', 'UpdateNewsTickerDetails')->name('update.newsTickerDetails');
        Route::get('/delete/newsTickerDetails/{id}', 'DeleteNewsTickerDetails')->name('delete.newsTickerDetails');
        // Route::get('/newsTickerDetails/ajax/{category_id}', 'GetNewsTickerDetails');
    });

    // Vendor Commission All Route
    Route::controller(VendorCommissionController::class)->group(function () {
        Route::get('/all/vendorCommission', 'AllVendorCommission')->name('all.vendorCommission');
        Route::get('/add/vendorCommission', 'AddVendorCommission')->name('add.vendorCommission');
        Route::post('/store/vendorCommission', 'StoreVendorCommission')->name('store.vendorCommission');
        Route::get('/edit/vendorCommission/{id}', 'EditVendorCommission')->name('edit.vendorCommission');
        Route::post('/update/vendorCommission', 'UpdateVendorCommission')->name('update.vendorCommission');
        Route::get('/delete/vendorCommission/{id}', 'DeleteVendorCommission')->name('delete.vendorCommission');
    });
...
Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    Route::get('/vendorrating', [IndexController::class, 'vendorrating'])->name('vendorrating');
    Route::get('/vendor_rating/{id}', [IndexController::class, 'vendorrating'])->name('vendor_rating');
