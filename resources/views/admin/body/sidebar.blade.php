    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">News Ticker</div>
            </a>
            <ul>
                <li> <a href="{{ route('all.newsTicker') }}"><i class="bx bx-right-arrow-alt"></i>All News Ticker</a>
                </li>
                <li> <a href="{{ route('add.newsTicker') }}"><i class="bx bx-right-arrow-alt"></i>Add News Ticker</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">News Ticker Details</div>
            </a>
            <ul>
                <li> <a href="{{ route('all.newsTickerDetails') }}"><i class="bx bx-right-arrow-alt"></i>All News Ticker
                        Details</a>
                </li>
                <li> <a href="{{ route('add.newsTickerDetails') }}"><i class="bx bx-right-arrow-alt"></i>Add News Ticker
                        Details</a>
                </li>
            </ul>
        </li>
        ...
        @if (Auth::user()->can('vendor.menu'))
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{ route('become.vendor') }}"><i class="bx bx-right-arrow-alt"></i>Add
                        Vendor</a>
                </li>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Vendor Commission</div>
            </a>
            <ul>
                <li> <a href="{{ route('all.vendorCommission') }}"><i class="bx bx-right-arrow-alt"></i>All Vendor Commission</a>
                </li>
                <li> <a href="{{ route('add.vendorCommission') }}"><i class="bx bx-right-arrow-alt"></i>Add Vendor Commission</a>
                </li>
            </ul>
        </li>
