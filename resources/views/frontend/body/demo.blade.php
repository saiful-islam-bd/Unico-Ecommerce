...
<header class="header-area header-style-1 header-height-2">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        <ul>
                            ...
                            <li>
                                <a class="language-dropdown-active" href="#" style="font-size:14px;">English <i
                            ...
                            <li style="font-size:14px;">Need help? Call Us: <strong class="text-brand"
                                    style="font-size:14px;"> + 1900</strong></li>
    ...
    @endphp
    <div class="header-middle header-middle-ptb-1 d-none d-lg-block" style="padding: 1rem 0;">
        <div class="container">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        ...
                                        <div class="shopping-cart-button">
                                            <a href="{{ route('mycart') }}" class="outline"
        ...
        <div class="container">
            <div class="row">
                <div class="col-2 col-md-1 vanish offer-mbl"
                    style=" height: 45px; padding-top: 7px; padding-left: 20px; padding-right: 0px; margin:auto; background-color: #3bb77e;">
                    <p class="off-font" style="font-weight: 500; font-size: 20px; color:#fff; margin-top:4px;">Offers
                        :</p>
                </div>
                <!----------------- mobile view ------------------->
                <!--<div class="col-2 col-md-2 upate-mbl vanish-desk" style=" height: 46px; padding-top: 5px; padding-left: 10px; padding-right: 0px; margin:auto; background-color: red;border-top: 1px #3bb77e solid; border-bottom: 1px #29a4d1 solid;">-->
                <!--    <p class="font-mbl" style="font-weight: 400; font-size: 17px; color:#fff;">Soddo</p>-->
                <!--</div>-->
                <!----------------- mobile view ------------------->
                ...
                <div class="col-10 col-md-11" style="padding-left: 0px; padding-right: 0px;">
                    <div class="Scriptcontent">
                        <div class="ticker-wrap ticker-wrap-mbl">
                            <div class="ticker">
                                <div class="ticker__item">The purpose of the media is to inform their audience of
                                    something new. </div>
                                <div class="ticker__item">
                                    Media releases succeed if they follow journalistic practices. These include, for
                                    example, subtitles in the scrolling text.
                                </div>
                                <div class="ticker__item">These include, for example, subtitles in the scrolling text.
                                </div>
                                <div class="ticker__item">
                                    The purpose of the media is to inform their audience of something new.
                                </div>
                                <div class="ticker__item">
                                    Media releases succeed if they follow journalistic practices. These include, for
                                    example, subtitles in the scrolling text.
