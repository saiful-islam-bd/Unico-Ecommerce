         ...
         <div class="row align-items-center">
             ...
             <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                 <p>
                     ...
                     All rights reserved | Developed by <a style="color: #b50746 !important;"  href="https://www.unicoitlimited.com/" target="_blank">Unico It
                         Limited</a>
             ...
             <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                 <div class="mobile-social-icon">
                     <h6>Follow Us</h6>
                     <a style="background: #b50746 !important;" href="{{ $setting->facebook }}"><img
                             src="{{ asset('frontend/assets/imgs/theme/icons/icon-facebook-white.svg') }}"
                             alt="" /></a>
                     <a  style="background: #b50746 !important;" href="{{ $setting->twitter }}"><img
                             src="{{ asset('frontend/assets/imgs/theme/icons/icon-twitter-white.svg') }}"
                             alt="" /></a>
                      <a style="background: #b50746 !important;"  href="#"><img
                     ...
                     <a style="background: #b50746 !important;"  href="#"><img
                             ...
                             alt="" /></a>
                     <a style="background: #b50746 !important;"  href="{{ $setting->youtube }}"><img
